...
export default function Intro() {
  return (
    <section id="about" className="bg-white text-brand-charcoal py-24 md:py-40 lg:py-52 px-10 md:px-12">
      <div className="max-w-4xl lg:max-w-5xl mx-auto text-center">
        <motion.div
           ...
           className="space-y-12 md:space-y-8 lg:space-y-12"
        >
          <div className="w-12 lg:w-16 h-[1px] bg-black mx-auto" />
          <h2 className="text-sm md:text-base lg:text-xl font-light leading-relaxed lg:leading-[2] opacity-80 text-brand-charcoal/80 break-keep mx-auto lg:max-w-[90%]">
            선진 민간수사 그룹은<br />
