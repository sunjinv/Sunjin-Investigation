...
export default function Intro() {
  return (
    <section id="about" className="bg-white text-brand-charcoal py-24 md:py-40 px-10 md:px-12">
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <h2 className="text-xl md:text-3xl font-serif leading-[1.8] md:leading-relaxed tracking-tight break-keep">
            선진 민간수사 그룹은<br />
