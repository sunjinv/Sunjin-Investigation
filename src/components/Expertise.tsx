...
const expertises = [
  {
    ...
    className: "col-span-12 md:col-span-8 h-[400px] md:h-[500px] lg:h-[600px]",
  ...
  },
  {
    ...
    className: "col-span-12 md:col-span-4 h-[400px] md:h-[500px] lg:h-[600px]",
  ...
  },
  {
    ...
    className: "col-span-12 md:col-span-4 h-[400px] lg:h-[450px]",
...
export default function Expertise() {
  return (
    <section id="expertise" className="bg-brand-charcoal py-24 md:py-32 lg:py-48">
      <div className="max-w-7xl lg:max-w-[1400px] mx-auto px-0 md:px-6">
        <div className="grid grid-cols-12 gap-0 md:gap-4 lg:gap-1">
