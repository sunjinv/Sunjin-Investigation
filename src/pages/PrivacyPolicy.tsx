    ...
    <div className="min-h-screen bg-brand-charcoal pt-32 pb-24 px-6 md:px-12 text-white/70">
      <div className="max-w-4xl mx-auto space-y-12">
        <div className="text-center space-y-4">
          <h1 className="text-3xl md:text-4xl font-serif tracking-[0.2em] text-white">개인정보처리방침</h1>
        </div>

        <div className="space-y-8 text-[15px] leading-[1.8] font-light break-keep">
          <p>
            회사명(이하 ‘회사’라 한다)는 개인정보 보호법 제30조에 따라 정보 주체의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보 처리지침을 수립, 공개합니다.
          </p>

          <section>
            <h2 className="text-lg font-medium text-white mb-4">제1조 (개인정보의 처리목적)</h2>
            <p className="mb-4">
          ...
          <section>
            <h2 className="text-lg font-medium text-white mb-4">제2조 (개인정보의 처리 및 보유기간)</h2>
            ...
            <ul className="space-y-2 list-decimal pl-5">
              <li>
                홈페이지 회원 가입 및 관리 : 사업자/단체 홈페이지 탈퇴 시까지<br/>
          ...
          <section>
            <h2 className="text-lg font-medium text-white mb-4">제3조 (개인정보의 제3자 제공)</h2>
          ...
          <section>
            <h2 className="text-lg font-medium text-white mb-4">제4조 (개인정보처리의 위탁)</h2>
            <p className="mb-2">① 회사는 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.</p>
            <div className="mb-4 space-y-4">
              <div>
                <strong>위탁업무 내용</strong>
                <ul className="list-disc pl-5 space-y-1 mt-1">
                  <li>위탁받는 자 (수탁자) : (주)아임웹</li>
                  <li>위탁하는 업무의 내용 : 쇼핑몰 호스팅 서비스의 시스템 제공, 모바일 앱 서비스, 마케팅 서비스 및 부가, 제휴서비스 제공 및 알림톡, 친구톡, 문자메시지 발송대행 서비스 등</li>
                  <li>위탁받는 자 (수탁자) : OOO PG</li>
                  <li>위탁하는 업무의 내용 : 결제 및 에스크로 업무</li>
                  <li>위탁받는 자 (수탁자) : OOO 택배</li>
                  <li>위탁하는 업무의 내용 : 상품 배송 업무</li>
                  <li>위탁받는 자 (수탁자) : OOO 고객센터</li>
                  <li>위탁하는 업무의 내용 : 고객상담 업무</li>
                  <li>위탁받는 자 (수탁자) : OOO</li>
                  <li>위탁하는 업무의 내용 : 본인확인 업무</li>
                </ul>
              </div>
              <div>
                <strong>재위탁사</strong>
                <ul className="list-disc pl-5 space-y-1 mt-1">
                  <li>재위탁받는 자(수탁자) : (주)아임웹 → 인포빕(유)</li>
                  <li>위탁하는 업무의 내용 : 문자메시지 발송, 카카오톡 알림톡(정보성 메시지) 발송 업무</li>
                  <li>재위탁받는 자(수탁자) : (주)아임웹 → (주)루나소프트</li>
                  <li>위탁하는 업무의 내용 : 문자메시지 발송, 카카오톡 알림톡(정보성 메시지) 및 친구톡 발송 업무</li>
                </ul>
              </div>
            </div>
          ...
          <section>
            <h2 className="text-lg font-medium text-white mb-4">제5조 (정보주체 및 법정대리인의 권리와 그 행사 방법)</h2>
            ...
            <p className="mb-2">③ 정보주체가 개인정보의 오류 등에 대한 정정 또는 삭제를 요구한 경우에는 회사는 정정 또는 삭제를 완료할 때까지 당해 개인정보를 이용하거나 제공하지 않습니다.</p>
            <p className="mb-2">④ 제1항에 따른 권리 행사는 정보주체의 법정대리인이나 위임을 받은 자 등 대리인을 통하여 하실 수 있습니다. 이 경우 개인정보 보호법 시행규칙 별지 제11호 서식에 따른 위임장을 제출하셔야 합니다.</p>
            <p>⑤ 정보주체는 개인정보 보호법 등 관계 법령을 위반하여 회사가 처리하고 있는 정보주체 본인이나 타인의 개인정보 및 사생활을 침해하여서는 아니 됩니다.</p>
          </section>

          <section>
            <h2 className="text-lg font-medium text-white mb-4">제6조 (처리하는 개인정보 항목)</h2>
          ...
          <section>
            <h2 className="text-lg font-medium text-white mb-4">제7조 (개인정보의 파기)</h2>
            <p className="mb-2">① 회사는 개인정보 보유 기간의 경과, 처리목적 달성 등 개인정보가 불필요하게 되었을 때에는 지체없이 해당 개인정보를 파기합니다.</p>
            <p className="mb-2">② 정보주체로부터 동의받은 개인정보 보유 기간이 경과하거나 처리목적이 달성되었음에도 불구하고 다른 법령에 따라 개인정보를 계속 보존하여야 하는 경우에는, 해당 개인정보를 별도의 데이터베이스(DB)로 옮기거나 보관장소를 달리하여 보존합니다.</p>
          ...
          <section>
            <h2 className="text-lg font-medium text-white mb-4">제8조 (개인정보의 안전성 확보조치)</h2>
          ...
          <section>
            <h2 className="text-lg font-medium text-white mb-4">제9조 (개인정보 자동 수집 장치의 설치∙운영 및 거부에 관한 사항)</h2>
            <p className="mb-2">① 회사는 이용자에게 개별적인 맞춤 서비스를 제공하기 위해 이용정보를 저장하고 수시로 불러오는 ‘쿠키(cookie)’를 사용합니다.</p>
            <p className="mb-2">② 쿠키는 웹사이트를 운영하는데 이용되는 서버(http)가 이용자의 컴퓨터 브라우저에 보내는 소량의 정보이며 이용자들의 PC 또는 모바일에 저장됩니다.</p>
            <p className="mb-4">③ 정보주체는 웹 브라우저 옵션 설정을 통해 쿠키 허용, 차단 등의 설정을 할 수 있습니다. 다만, 쿠키 저장을 거부할 경우 맞춤형 서비스 이용에 어려움이 발생할 수 있습니다.</p>
            
            <div className="mb-4">
              <strong>▶ 웹 브라우저에서 쿠키 허용/차단</strong>
            ...
            <div className="mb-4">
              <strong>▶ 모바일 브라우저에서 쿠키 허용/차단</strong>
              <ul className="list-none pl-4 mt-1 space-y-1">
          ...
          <section>
            <h2 className="text-lg font-medium text-white mb-4">제10조 (개인정보 보호책임자)</h2>
            <p className="mb-4">① 회사는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만 처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.</p>
            ...
            <div className="mb-4">
              ...
              <span className="text-sm opacity-70">※ 개인정보 보호 담당부서로 연결됩니다.</span>
            </div>

            <div className="mb-4">
              <strong>▶ 개인정보 보호 담당부서</strong><br/>
              부서명 : OOO 팀<br/>
              연락처 : &lt;전화번호&gt;, &lt;이메일&gt;, &lt;팩스번호&gt;
            </div>
          ...
          <section>
            <h2 className="text-lg font-medium text-white mb-4">제11조 (개인정보 열람청구)</h2>
          ...
          <section>
            <h2 className="text-lg font-medium text-white mb-4">제12조 (권익침해 구제 방법)</h2>
          ...
          <section>
            <h2 className="text-lg font-medium text-white mb-4">제13조 (개인정보 처리방침 시행 및 변경)</h2>
